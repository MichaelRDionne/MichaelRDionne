...
| --- | --- | --- | ---: | --- | --- | --- |
| [prompt-eval-harness](https://github.com/MichaelRDionne/prompt-eval-harness) | Evaluation-first prompt development, live weekly dashboard | 2026-09-07 | 0 | completed/success | MIT | [live](https://michaelrdionne.github.io/prompt-eval-harness/) |
